...
License  : MIT
Requires: azure-mgmt-consumption-python = %{version}-%{release}
Requires: azure-mgmt-consumption-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-consumption package.
Group: Default
Requires: azure-mgmt-consumption-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-consumption package.


%package python3
Summary: python3 components for the azure-mgmt-consumption package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_consumption)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-consumption package.


%prep
%setup -q -n azure-mgmt-consumption-3.0.0
cd %{_builddir}/azure-mgmt-consumption-3.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588789232
